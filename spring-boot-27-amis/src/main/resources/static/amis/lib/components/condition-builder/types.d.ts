...
export declare type FieldTypes = 'text' | 'number' | 'boolean' | 'date' | 'time' | 'datetime' | 'select' | 'custom';
...
export declare type FieldSimple = TextField | NumberField | DateField | TimeField | DatetimeField | SelectField | BooleanField | CustomField;
