...
declare const _default: {
    new (props: Pick<Omit<LayoutProps, keyof import("../theme").ThemeProps>, "aside" | "header" | "children" | "size" | "contentClassName" | "headerClassName" | "bodyClassName" | "folded" | "boxed"> & Partial<Pick<Omit<LayoutProps, keyof import("../theme").ThemeProps>, "footer" | "asideClassName" | "asideFixed" | "headerFixed" | "offScreen">> & Partial<Pick<{
        asideFixed: boolean;
        asideClassName: string;
        headerFixed: boolean;
        offScreen: boolean;
        ...
        readonly props: Readonly<Pick<Omit<LayoutProps, keyof import("../theme").ThemeProps>, "aside" | "header" | "children" | "size" | "contentClassName" | "headerClassName" | "bodyClassName" | "folded" | "boxed"> & Partial<Pick<Omit<LayoutProps, keyof import("../theme").ThemeProps>, "footer" | "asideClassName" | "asideFixed" | "headerFixed" | "offScreen">> & Partial<Pick<{
            asideFixed: boolean;
            asideClassName: string;
            headerFixed: boolean;
            offScreen: boolean;
