...
declare const _default: {
    new (props: Omit<Pick<Omit<ToastComponentProps, keyof LocaleProps>, "classPrefix" | "classnames" | "className" | "theme" | "showIcon" | "useMobileUI"> & Partial<Pick<Omit<ToastComponentProps, keyof LocaleProps>, "position" | "items" | "timeout" | "closeButton" | "errorTimeout">> & Partial<Pick<Pick<ToastComponentProps, "position" | "items" | "timeout" | "closeButton" | "errorTimeout">, never>> & {
