...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.onFocus = function (e) {
        ...
        this.props.onFocus && this.props.onFocus((0, tslib_1.__assign)((0, tslib_1.__assign)({}, e), { value: value }));
    };
    Select.prototype.onBlur = function (e) {
        ...
        this.props.onBlur && this.props.onBlur((0, tslib_1.__assign)((0, tslib_1.__assign)({}, e), { value: value }));
    };
    ...
    Select.prototype.render = function () {
        var _this = this;
        var _a = this.props, cx = _a.classnames, multiple = _a.multiple, valuesNoWrap = _a.valuesNoWrap, searchable = _a.searchable, inline = _a.inline, className = _a.className, value = _a.value, loading = _a.loading, clearable = _a.clearable, labelField = _a.labelField, disabled = _a.disabled, checkAll = _a.checkAll, borderMode = _a.borderMode, useMobileUI = _a.useMobileUI;
        var selection = this.state.selection;
        var inputValue = this.state.inputValue;
