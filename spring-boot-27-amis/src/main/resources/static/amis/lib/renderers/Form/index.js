...
var Form = /** @class */ (function (_super) {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        dispatcher = dispatchEvent('inited', (0, helper_1.createObject)(this.props.data, data));
    ...
    Form.prototype.emitChange = function (submit) {
        var _a = this.props, onChange = _a.onChange, store = _a.store, submitOnChange = _a.submitOnChange, dispatchEvent = _a.dispatchEvent, data = _a.data;
        if (!(0, mobx_state_tree_1.isAlive)(store)) {
            return;
        }
        var dispatcher = dispatchEvent('change', (0, helper_1.createObject)(data, store.data));
        if (!(dispatcher === null || dispatcher === void 0 ? void 0 : dispatcher.prevented)) {
            onChange &&
    ...
    Form.prototype.handleAction = function (e, action, data, throwErrors, delegate) {
        ...
        if (Array.isArray(action.required) && action.required.length) {
            return store.validateFields(action.required).then(function (result) {
                if (!result) {
                    dispatchEvent('validateError', _this.props.data);
                ...
                if (target) {
                    ...
                    return store
                        ...
                        onSuccess: function (result) {
                            // result为提交接口返回的内容
                            dispatchEvent('submitSucc', (0, helper_1.createObject)(_this.props.data, { result: result }));
                        ...
                        onFailed: function (result) {
                            dispatchEvent('submitFail', (0, helper_1.createObject)(_this.props.data, { error: result }));
                        }
                    })
