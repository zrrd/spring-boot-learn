...
declare const ThemedNavigation: {
    new (props: Pick<Omit<NavigationProps, keyof ThemeProps>, "data" | "source" | "hidden" | "reload" | "disabled" | "onToggle" | "id" | "onSelect" | "loading" | "visible" | "draggable" | "render" | "env" | "links" | "$ref" | "disabledOn" | "hiddenOn" | "visibleOn" | "itemBadge" | "deferApi" | "itemActions" | "saveOrderApi" | "stacked" | "dragOnSameLevel" | "overflow" | "onDragUpdate" | "onOrderChange" | "togglerClassName"> & Partial<Pick<Omit<NavigationProps, keyof ThemeProps>, "indentSize">> & Partial<Pick<Pick<NavigationProps, "indentSize">, never>> & import("../theme").ThemeOutterProps): {
        ref: any;
