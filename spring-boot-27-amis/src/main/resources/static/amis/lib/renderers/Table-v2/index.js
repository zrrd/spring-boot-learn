        ...
        Array.isArray(columns) &&
            columns.forEach(function (column, col) {
                ...
                var titleRender = function (children) {
                    ...
                    return (react_1.default.createElement("div", { className: cx('Table-head-cell-wrapper') },
                        content,
                        remark,
                        children));
                };
