...
import { BaseSchema, SchemaApi, SchemaClassName, SchemaExpression, SchemaObject, SchemaType } from '../../Schema';
import type { OnEventProps } from '../../utils/renderer-event';
export declare type FormControlSchemaAlias = SchemaObject;
export interface FormBaseControl extends Omit<BaseSchema, 'type'>, OnEventProps {
    /**
     * 表单项类型
     */
    type: SchemaType;
