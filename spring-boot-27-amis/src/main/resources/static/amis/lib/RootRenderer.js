    ...
    RootRenderer.prototype.handleAction = function (e, action, ctx, throwErrors, delegate) {
        ...
        if (action.actionType === 'reload') {
            ...
            (_b = (_a = action.toast) === null || _a === void 0 ? void 0 : _a.items) === null || _b === void 0 ? void 0 : _b.forEach(function (item) {
                env.notify(item.level || 'info', item.body ? (0, Root_1.renderChild)('body', item.body, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, _this.props), { data: ctx })) : '', (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, action.toast), item), { title: item.title ? (0, Root_1.renderChild)('title', item.title, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, _this.props), { data: ctx })) : null, useMobileUI: env.useMobileUI }));
            });
        }
