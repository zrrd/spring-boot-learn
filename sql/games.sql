...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '游戏表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of game
-- ----------------------------
INSERT INTO `game` VALUES (1, 'hh', 10.00, '2018-07-03', 1, NULL);
INSERT INTO `game` VALUES (2, 'd', 2.00, '2018-07-03', 3, NULL);
INSERT INTO `game` VALUES (3, 'd', 2.00, '2018-07-03', 3, NULL);
INSERT INTO `game` VALUES (4, 'd', 2.00, '2018-07-03', 3, NULL);
INSERT INTO `game` VALUES (5, 'd', 2.00, '2018-07-03', 3, NULL);
INSERT INTO `game` VALUES (6, 'd', 2.00, '2018-07-03', 3, NULL);
INSERT INTO `game` VALUES (7, 'aa', 10.20, '2008-01-05', 8, NULL);
...
CREATE TABLE `steam`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '游戏库' ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'hello', 10, 1001, 'rpg');
